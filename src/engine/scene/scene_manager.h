...
namespace engine::scene {
    ...
    public:
        ...
        // 延时切换场景
        void requestPushScene(std::unique_ptr<Scene>&& scene);      //压入一个新场景。
        void requestPopScene();                                     //弹出当前场景。
        void requestReplaceScene(std::unique_ptr<Scene>&& scene);   //替换当前场景。
